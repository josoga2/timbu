        ...
        <main>
            ...
            <section className="md:hidden p-5">
                <div className="w-full flex flex-col gap-5">
                    ...
                    <div className="p-2 rounded-md text-timbu-white bg-timbu-green text-center"> <a href="/complete">Pay NGN 203,000</a> </div>
                    <div className="p-2 rounded-md text-timbu-black border-2 border-timbu-black bg-timbu-white text-center flex gap-5 items-center justify-center"> <TbArrowsExchange className="text-2xl" /> <a href="/payment"> Change payment method</a></div>
                    <div className="p-2 rounded-md text-timbu-black border-2 border-timbu-black bg-timbu-white text-center flex gap-5 items-center  justify-center"> <GiCancel className="text-2xl" /> <a href="/">  Cancel payment</a></div>
                </div>
